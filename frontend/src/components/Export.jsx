...
function Export() {
  const stData = useOutletContext()[0];

  async function generatePdfApi() {
    console.log(stData.id);
    console.log(stData);
    const api = await fetch(
      `http://127.0.0.1:8000/students/generatePdf/${stData.id}`,
      {
        method: "Post",
      }
    );
  ...
  return (
    <div className="export-container">
          ...
          <div className="pdf-other-info">
            ...
            <div className="info-content">
              ...
              <div className="info-container">
                ...
                <span className="info-value">{stData.fathersoccupation}</span>
              </div>
              <div className="info-container">
              ...
              <div className="info-container">
                ...
                <span className="info-value">{stData.mothersoccupation}</span>
              </div>
              <div className="info-container">
      ...
      <button className="btn download-btn" onClick={generatePdfApi}>
        {" "}
